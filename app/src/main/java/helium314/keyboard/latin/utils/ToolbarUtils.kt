...
enum class ToolbarKey {
    VOICE, CLIPBOARD, PHRASE, NUMPAD, UNDO, REDO, SETTINGS, SELECT_ALL, SELECT_WORD, COPY, CUT, PASTE, ONE_HANDED, FLOATING, SPLIT,
...
val defaultToolbarPref by lazy {
    val default = listOf(SETTINGS, VOICE, CLIPBOARD, PHRASE, UNDO, REDO, SELECT_WORD, COPY, PASTE, LEFT, RIGHT)
