...
//            NAME_PREVIOUS_KEY to                null,
            ...
            ToolbarKey.entries.forEach {
                put(it.name.lowercase(Locale.US), when (it) {
                    ...
                    ToolbarKey.PHRASE -> R.drawable.sym_keyboard_clipboard_holo
...
//            NAME_SPACE_KEY to                   null,
            ...
            ToolbarKey.entries.forEach {
                put(it.name.lowercase(Locale.US), when (it) {
                    ...
                    ToolbarKey.PHRASE -> R.drawable.sym_keyboard_clipboard_lxx
...
//            NAME_SPACE_KEY to                   null,
            ...
            ToolbarKey.entries.forEach {
                put(it.name.lowercase(Locale.US), when (it) {
                    ...
                    ToolbarKey.PHRASE -> R.drawable.sym_keyboard_clipboard_rounded
                    ToolbarKey.NUMPAD -> R.drawable.sym_keyboard_numpad_key_lxx
